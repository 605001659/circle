 ...
 */
@Controller
@RequestMapping("/platform/popularity")
public class PopularityController {
	 ...
	 * @return 视图层
	 */
	@RequestMapping("/toPopularityList")
	public String toPointList() {
		return "platform/popularity/popularityList";
	}
	 ...
	 * @return
	 */
	@RequestMapping("/getPopularityList")
	@ResponseBody
	public ReusltItem getPopularityList(String name, String page,String size){
